        ...
        <div className="grid md:grid-cols-[400px,1fr] gap-16 lg:gap-32">
          ...
          <div className="space-y-16 mb-14">
            ...
            <div>
              ...
              <div className="space-y-4 text-base">
                ...
                <p>Emails: customer@nike-ecommerce.com</p>
                <p>Emails: support@ecommerce-nike.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-end">
              <Button className="bg-blue-500 hover:bg-blue-800 h-14 px-12 rounded-sm text-base">
                Send Message
              </Button>
            </div>
          </div>
